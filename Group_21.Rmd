...
In future we can consider more factors to have better insights on this happiness report such as 
population of the country: as population increases the diversity increases and getting same facilities for everyone becomes difficult because of less number of resources and more number of people, facilities available in a country: as european countires can have better facilities because they can plan their facilities as population is very less, effect of natural calamities: some countries will face extreme conditions such as flood, tsunami etc. frequently which affects human life, effect of pollution: Population affects environment and eventually affects human life.
We can use different approach and also can fit different models by considering the topics mentioned above.
